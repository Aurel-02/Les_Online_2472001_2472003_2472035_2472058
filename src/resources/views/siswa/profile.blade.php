...
>>>>>>> f1477981be828601e79080bb40992bd330fffc3a
        ...
        <div class="profile-card">
            ...
            <form action="{{ route('siswa.profile.update') }}" method="POST" id="profileForm" style="width: 100%;">
                @csrf
                <div class="info-grid">
                    <div class="info-item">
                    ...
                    <div class="info-item">
                        <label class="info-label">Jenjang Pendidikan</label>
                        <select name="id_jenjang" class="info-value">
                            <option value="1" {{ old('id_jenjang', $userJenjang) == 1 ? 'selected' : '' }}>SD</option>
                            <option value="2" {{ old('id_jenjang', $userJenjang) == 2 ? 'selected' : '' }}>SMP</option>
                            <option value="3" {{ old('id_jenjang', $userJenjang) == 3 ? 'selected' : '' }}>SMA</option>
                        </select>
                    </div>
                    <div class="info-item">
        ...
        function confirmChangePassword() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "{{ route('siswa.profile.password') }}";
                }
            });
        }
    </script>
