    ...
    <main class="main-wrapper">
        ...
        <div class="content-body">
            <div class="profile-card">
                <h1 class="page-title" style="font-size: 28px; font-weight: 800; color: var(--dark-oak); margin-bottom: 24px;">Ubah Password</h1>
                ...
                <form action="{{ route('admin.profile.password.update') }}" method="POST" style="width: 100%;">
                    @csrf
                    <div class="info-grid">
                        <div class="info-item">
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn-save" style="margin-right: 12px;">Ubah Password</button>
                        <a href="{{ route('admin.profile') }}" class="btn-password" style="display:flex; align-items:center; text-decoration:none;">Batal</a>
                    </div>
                </form>
            </div>
        </div>
