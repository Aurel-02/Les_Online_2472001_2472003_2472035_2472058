    ...
    <div class="app-container">
        <header class="top-header">
            ...
            <div class="center-nav">
                ...
                <a href="{{ route('orangtua.profile') }}" class="nav-pill active">Profil</a>
            </div>
            <div class="right-nav">
        ...
        <div class="profile-card">
            ...
            <form action="{{ route('orangtua.profile.password.update') }}" method="POST" style="width: 100%;">
                @csrf
                <div class="info-grid">
                    <div class="info-item">
                ...
                <div class="form-actions">
                    ...
                    <a href="{{ route('orangtua.profile') }}" class="btn-cancel">Batal</a>
                </div>
            </form>
