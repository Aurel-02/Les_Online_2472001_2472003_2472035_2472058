...
<body>
    ...
    <div class="app-container">
        <header class="top-header">
            <a href="{{ route('guru.dashboard') }}" class="brand">Pintar.id</a>
            <div class="center-nav">
                <a href="{{ route('guru.dashboard') }}" class="nav-pill">Beranda</a>
                <a href="{{ route('guru.profile') }}" class="nav-pill active">Profil</a>
            </div>
            <div class="right-nav">
        ...
        <div class="profile-card">
            ...
            <form action="{{ route('guru.profile.password.update') }}" method="POST" style="width: 100%;">
                @csrf
                <div class="info-grid">
                    <div class="info-item">
                ...
                <div class="form-actions">
                    ...
                    <a href="{{ route('guru.profile') }}" class="btn-cancel">Batal</a>
                </div>
            </form>
