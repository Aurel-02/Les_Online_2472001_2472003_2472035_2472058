...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Outfit', sans-serif; }
        ...
        .form-label { display: block; font-weight: 600; margin-bottom: 8px; color: var(--dark-oak); }
        .form-control { width: 100%; padding: 14px 18px; border-radius: 12px; border: 1px solid rgba(61,43,31,0.2); background: rgba(255,255,255,0.8); font-family: 'Outfit'; font-size: 15px; transition: all 0.3s ease; outline: none; }
    ...
    <main class="main-wrapper">
        ...
        <div class="content-body">
            ...
            <div class="glass-card">
                <form action="{{ isset($materi) ? route('guru.materi.update', $materi->id_materi) : route('guru.materi.store') }}" method="POST">
                    @csrf
                    @if(isset($materi))
                        @method('PUT')
                    @endif
