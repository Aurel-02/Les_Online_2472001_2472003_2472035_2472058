...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Outfit', sans-serif; }
        ...
        /* Blobs & Sidebar (Copied from Dashboard) */
        ...
        .btn-primary { background: var(--muted-sage); color: white; padding: 12px 24px; border-radius: 99px; font-weight: 600; text-decoration: none; display: inline-flex; align-items: center; gap: 8px; transition: all 0.3s ease; border: none; cursor: pointer; }
        ...
        .btn-sm { padding: 6px 12px; border-radius: 8px; font-size: 13px; font-weight: 600; text-decoration: none; }
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge badge-{{ strtolower($m->jenjang) }}">{{ $m->jenjang }}</span>
                                </td>
                                <td>
                                    @if($m->link_video)
                                        <a href="{{ $m->link_video }}" target="_blank" style="color:var(--muted-sage); font-weight:600;">Lihat Video</a>
                                    @else
                                        -
                                    @endif
                                </td>
                                ...
                                <td>
                                    <div class="action-btns">
                                        <a href="{{ route('guru.materi.edit', $m->id_materi) }}" class="btn-sm btn-edit">Edit</a>
                                        <form action="{{ route('guru.materi.destroy', $m->id_materi) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus materi ini?');">
                                            @csrf
                                            @method('DELETE')
                            ...
                            <tr>
                                <td colspan="5">
                                    <div class="empty-state">Belum ada materi yang ditambahkan. Silakan klik "Tambah Materi".</div>
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
