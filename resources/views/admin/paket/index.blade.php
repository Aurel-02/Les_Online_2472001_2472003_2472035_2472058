...
<head>
    ...
    <title>Manajemen Paket - Pintar.id</title>
    ...
    <style>
        ...
        * {
        ...
        .btn-action-danger {
            background: #ffe3e3; color: #d63333;
        }
...
<body>
    ...
    <main class="main-wrapper">
        ...
        <div class="content-body">
            @if(session('success'))
                <div style="background: rgba(142, 150, 128, 0.2); color: #555E49; padding: 16px; border-radius: 12px; margin-bottom: 24px; font-weight: 600;">
                    {{ session('success') }}
                </div>
            @endif
            ...
            <div class="section-header">
                <div>
                    <h2 class="section-title">Manajemen Paket Belajar</h2>
                    <p class="section-subtitle">Kelola paket belajar yang tersedia untuk siswa.</p>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <form action="{{ route('admin.paket.destroy', $paket->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus paket ini?');" style="display:inline-block;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn-table-action btn-action-danger">Hapus</button>
                                    </form>
                                </td>
                            </tr>
                            @empty
                            <tr>
                                <td colspan="5" style="text-align: center; color: rgba(61,43,31,0.5);">Belum ada data paket belajar.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
