...
class AdminController extends Controller
{
    ...
    public function penggunaIndex(Request $request)
    {
        ...
        return view('user.index', array_merge($sd, compact('users', 'roleCounts', 'role', 'search')));
    }
     ...
     */
    public function penggunaToggleStatus($id)
    {
        $session     = UserSession::getInstance();
        $currentUser = $session->getUser();
        ...
        $message = $newStatus === 'aktif' ? 'Akun pengguna berhasil diaktifkan kembali.' : 'Akun pengguna berhasil dinonaktifkan.';
